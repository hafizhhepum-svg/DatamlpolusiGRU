...
void grafik3(){
    ...
    std::ifstream infile("NO2_ALL.txt");
    ...
    gr->SetTitle(";NO_{2} Observed [AQI];NO_{2} Predicted [AQI]");    
    ...
    c1->SaveAs("./output/scatter_NO2_fit.png");
    c1->SaveAs("./output/scatter_NO2_fit.pdf");
}
