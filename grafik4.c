...
void grafik4(){
    ...
    std::ifstream infile("SO2_ALL.txt");
    ...
    gr->SetTitle(";SO_{2} Observed [AQI];SO_{2} Predicted [AQI]");
    ...
    c1->SaveAs("./output/scatter_SO_fit.png");
    c1->SaveAs("./output/scatter_SO_fit.pdf");
}
